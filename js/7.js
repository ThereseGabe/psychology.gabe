            ...
            if (isMobile()) {
                ...
                animatedElements = animatedElements.filter(function(el) {
                    if (!el.parents().filter(function(parentElement) {
                        if (parentElement.matches('a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal')) {
                            return true
                        }
                    }).length) {
                        return true
...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobirise.com/instagram-feed/">embed instagram feed</a> Mobirise v5.6.10 <a href="https://mobirise.com/extensions/popup-builder/">Popup Maker</a>';document.body.insertBefore(a,document.body.childNodes[0])}}();
